...
import androidx.compose.material3.Text // Importación necesaria para Text
...
private fun ComposableInfoCard(
    ...
    Column(
        modifier = modifier
            .fillMaxSize()
            .background(backgroundColor), // Sin padding para evitar separación
        ...
        // Primer texto con negrita, padding inferior y color negro
        Text(
            text = title,
            modifier = Modifier
        ...
        // Segundo texto con tamaño de fuente Default, color negro y padding horizontal
        Text(
            text = description,
